...
public class HelloUnity3D : MonoBehaviour
{
    ...
    public Sprite muteSprite, micSprite, speakerSprite, silentSprite;
    public Animator speakingAnim;
    ...
    void Start()
    {
        ...
        speakerButton.onClick.AddListener(SpeakerButtonTapped);
        ...
        mRtcEngine.OnError += (int error, string msg) =>
        {
            ...
            mShownMessage.GetComponent<Text>().text = (errorMessage);
        };
        ...
        mRtcEngine.OnConnectionLost += () =>
        {
            ...
            mShownMessage.GetComponent<Text>().text = (lostMessage);
        };
    ...
    void MuteButtonTapped()
    {
        ...
        // }
        muteButton.GetComponent<Image>().sprite = isMuted ? muteSprite : micSprite;   
    ...
    {
        speakerButton.GetComponent<Image>().sprite = isSpeaker ? speakerSprite : silentSprite;
